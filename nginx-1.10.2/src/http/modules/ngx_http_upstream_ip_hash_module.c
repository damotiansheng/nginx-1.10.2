...
// meet "ip_hash" in nginx.conf will call this func
static char *
ngx_http_upstream_ip_hash(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    uscf->peer.init_upstream = ngx_http_upstream_init_ip_hash; // call this func in ngx_http_upstream_init_main_conf 
