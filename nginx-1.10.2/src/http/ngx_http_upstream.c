...
ngx_http_upstream_connect(ngx_http_request_t *r, ngx_http_upstream_t *u)
{
    ...
    rc = ngx_event_connect_peer(&u->peer);  // connect upstream server
    ...
    c->write->handler = ngx_http_upstream_handler;  // will call u->write_event_handler or u->read_event_handler
...
// meet "upstream" will call this func
static char *
