...
// when meet "http" will call this func, and conf = &(((void **) cf->ctx)[ngx_http_module.index])
static char *
ngx_http_block(ngx_conf_t *cf, ngx_command_t *cmd, void *conf)
{
    ...
    *(ngx_http_conf_ctx_t **) conf = ctx;
    ...
    pcf = *cf; // http://blog.csdn.net/yusiguyuan/article/details/24481241
    cf->ctx = ctx; // cf->ctx is always chaned temporaily( restored after parse current context), 
    ...
    rv = ngx_conf_parse(cf, NULL);     // will call ngx_http_upstream func, meet "upstream" will call ngx_http_upstream, "upstream" is in http block
    ...
    // http://blog.csdn.net/yusiguyuan/article/details/26510663
...
// ngx_http_block -> .... -> ngx_http_add_listening, when meet "http" in nginx.conf, will call ngx_http_block
