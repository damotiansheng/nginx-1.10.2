...
// return the num of module whose cycle->module[x]->type=type and set module->ctx_index
ngx_int_t
...
// find a index which is not used in cycle->modules[x].ctx_index and cyle->old_cycle->modules[x].ctx_index
static ngx_uint_t
