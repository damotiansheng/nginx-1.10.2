...
//init the log file: /usr/local/nginx/logs, and return ngx_log_t for logging
ngx_log_t *
...
ngx_log_open_default(ngx_cycle_t *cycle)
{
    ...
    log->file = ngx_conf_open_file(cycle, &error_log); // insert logs/error.log into cycle->open_files
...
// insert new_log by new_log->log_level desc
static void
